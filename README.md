...
| 14 | [Binary Search](https://leetcode.com/problems/binary-search/) | [Code](./Binary%20Search/BinarySearch.cpp) | Binary Search | `O(log n)` |🟢 Easy |
| 15 | [Search Insert](https://leetcode.com/problems/search-insert-position/) | [Code](./Binary%20Search/SearchInsert.cpp) | Binary Search | `O(log n)` |🟢 Easy |
